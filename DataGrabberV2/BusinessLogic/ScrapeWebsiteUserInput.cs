...
namespace DataGrabberV2.BusinessLogic
{
    public class ScrapeWebsiteUserInput
    {
        ...
        public void Main()
        {
            ...
            {
                Logger.Write("Exception in Main -- ScrapeProductsListInput -> DataGrabberV2. Message: " + ex.Message);
            }
            finally
            {
        ...
        private void ProcessRequest(string URL)
        {
            ...
            {
                Logger.Write("Exception in ProcessRequest -- ScrapeProductsListInput -> DataGrabberV2. Message: " + ex.Message);
            }
            finally
            {
