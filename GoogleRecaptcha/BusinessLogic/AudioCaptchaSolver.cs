    ...
    public partial class AudioCaptchaSolver : CaptchaSolver, ICaptchaSolver
    {
        ...
        private void GetAudioURL()
        {
            try
            {
                ...
                {
                    Logger.Write($"ERROR: Could not find iframe, but google Captcha is present-> GoogleReCaptcha.");
            ...
            {
                Logger.Write("Exception in GetAudioURL -> GoogleReCaptcha. Message: " + ex.Message);
            }
        }
        ...
        private void DownloadFile()
        {
            ...
            {
                Logger.Write("Exception in DownloadFile -> GoogleReCaptcha. Message: " + ex.Message);
            }
        }
        ...
        private void ConvertMp3ToWav()
        {
            ...
            {
                Logger.Write("Exception in ConvertMp3ToWav -> GoogleReCaptcha. Message: " + ex.Message);
            }
        }
        ...
        private void ConvertWavToText()
        {
            ...
            {
                Logger.Write("Exception in ConvertWavToText -> GoogleReCaptcha. Message: " + ex.Message);
            }
        ...
        void Recognizer_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            {
                Logger.Write("Exception in ConvertWavToText - Recognizer_SpeechRecognized -> GoogleReCaptcha. Message: " + ex.Message);
            }
        }
        ...
        void Recognizer_RecognizeCompleted(object sender, RecognizeCompletedEventArgs e)
        {
            ...
            {
                Logger.Write("Exception in ConvertWavToText - Recognizer_RecognizeCompleted -> GoogleReCaptcha. Message: " + ex.Message);
            }
        }
